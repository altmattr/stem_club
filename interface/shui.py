...
modes = [
        ...
        , ("force hotspot",    "F", lambda: killable_script(["/home/pi/stem_club/field_modesh"], cwd="/home/pi/stem_club"))
        , ("training_capture", "T", lambda: killable_script(["/home/pi/stem_club/capture.sh"], progress=True))
        , ("image_net",        "s", lambda: killable_script(["python3", "-u", "/home/pi/stem_club/predict.py", "--model", "0", "--source", "1"], cwd="/home/pi/stem_club"))
        , ("covered?",         "c", lambda: killable_script(["python3", "-u", "/home/pi/stem_club/predict.py", "--model", "4", "--source", "1"], cwd="/home/pi/stem_club"))
        , ("zero one",         "z", lambda: killable_script(["python3", "-u", "/home/pi/stem_club/predict.py", "--model", "6", "--source", "1"], cwd="/home/pi/stem_club"))
        , ("numbers?",         "n", lambda: killable_script(["python3", "-u", "/home/pi/stem_club/predict.py", "--model", "7", "--source", "1"], cwd="/home/pi/stem_club"))
        , ("glasses?",         "g", lambda: killable_script(["python3", "-u", "/home/pi/stem_club/predict.py", "--model", "8", "--source", "1"], cwd="/home/pi/stem_club"))
        ]
ps = None
